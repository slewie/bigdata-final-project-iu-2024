url="https://disk.yandex.ru/d/qniTf_VSphsIfA"
mkdir data
...
hdfs dfs -mkdir /user/team27/project
hdfs dfs -mkdir /user/team27/project/warehouse
...
mkdir -p output
mv authors.avsc authors.java reviews.avsc reviews.java ./output